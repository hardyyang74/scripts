...
/forward/backward]: avrcp control"},
	...
	{"spp_connect",   NULL , cmd_bt_spp_client_connect,    "spp_connect dev_id dst channel"},
	{"spp_send",      NULL , cmd_bt_spp_client_send,       "spp_send data"},
	{"spp_disconnect",NULL , cmd_bt_spp_client_disconnect, "spp_disconnect dst"},
